  ...
  return (
    ...
    >
      ...
      <input
        ...
        {...props}
        ref={ref}
        className="h-12 outline-none placeholder:text-[var(--second-gray)] w-full placeholder:xl:text-lg placeholder:text-sm placeholder:text-xs bg-transparent border-none"
