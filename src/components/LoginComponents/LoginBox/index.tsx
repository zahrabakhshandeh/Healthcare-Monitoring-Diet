...
const LoginBox = () => {
  return (
    <div
      className={`${styles.SignupBox}  rounded-[3.4rem] bg-white left-0 lg:z-10 relative lg:absolute lg:w-[667px]  py-10 px-12 w-full lg:left-auto lg:bottom-auto lg:right-[5%] lg:top-[5%] gap-4 flex flex-col bottom-0 right-0 top-0 scale-75`}
    >
