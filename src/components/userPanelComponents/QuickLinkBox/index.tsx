...
const QuickLinkBox = ({subject, bodyText, badgeLogo}:QuickLinkBoxTypes) => {
    return(
        <Link href="./">
            <div className="flex justify-center flex-col bg-[var(--box-gray)] ps-10 lg:pe-3 pt-4 pb-5 rounded-2xl relative z-0 shadow-md md:mt-24 lg:p-2 scale-75   md:scale-100">
