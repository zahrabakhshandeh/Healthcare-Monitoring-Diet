...
const QuickLinkBox = ({subject, bodyText, badgeLogo}:QuickLinkBoxTypes) => {
    return(
        <Link href="./">
            <div className="flex justify-center flex-col bg-[var(--box-gray)] ps-10 lg:pe-3 pt-4 pb-5 rounded-2xl relative z-0 shadow-md mt-24 lg:p-2 scale-90 md:scale-100">
                <div className="flex flex-col gap-1 ">
                    <h1 className="text-2xl ps-3 pb-3 lg:ps-16">{subject}</h1>
